...
{
	SChartXYPoint() : X_(0.0), Y_(0.0)  
	{ 
		#ifndef NO_USER_DATA
		pUserData = NULL;
		#endif
	}
	SChartXYPoint(double XVal, double YVal) : X_(XVal), Y_(YVal)  
	{ 
		#ifndef NO_USER_DATA
		pUserData = NULL;
		#endif
	...
	double GetXMin() const { return X_; }
	double GetXMax() const { return X_; }
	double GetYMin() const { return Y_; }
	double GetYMax() const { return Y_; }
