/*****************************************************************************r
	    ...
	    COPYRIGHT (c) 1988, 1997 by Globetrotter Software Inc.
 ...
 *	2/13/88
 *
 *	Last changed:  10/12/97
 *
 */

#ifndef __RGI_LMCLIENT_H__
#define __RGI_LMCLIENT_H__
...
#define FLEXLM_REVISION 0
#define FLEXLM_PATCH "b"
...
#define LM_FLAG_IN_CONNECT	      0x400 
			   ...
			   char *hostname; 	
			   char *username; 	
			   char *internal1;	/* internal use */
			   char *internal2;	/* internal use */
...
lm_extern void API_ENTRY lc_checkin lm_args((LM_HANDLE_PTR, const LM_CHAR_PTR, 
							int ));
lm_extern int API_ENTRY lc_checkout lm_args((LM_HANDLE_PTR job, 
				const LM_CHAR_PTR feature,
			       const LM_CHAR_PTR  version, int nlic, 
			       int flag, const VENDORCODE_PTR key, int dup));
LM_CHAR_PTR API_ENTRY lc_chk_conf lm_args(( LM_HANDLE *, CONFIG *, int));
...
lm_extern CONFIG_PTR API_ENTRY lc_next_conf lm_args((LM_HANDLE_PTR job,
						     LM_CHAR_PTR feature,
						     CONFIG_PTR_PTR pos));
lm_extern int API_ENTRY lc_node_lock lm_args((LM_HANDLE_PTR job, LM_CHAR_PTR feature,
